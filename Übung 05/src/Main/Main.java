...
public class Main {
	...
	public static void main(String[] args)
	{
		...
		System.out.println("If you see the next output sorted, then your implementation of insert operation should be correct.");
		...
		// Search for 100 and 150 in the tree; 150 might exist in the tree or not, 100 should exist and 2000 should not exist.
		...
		// Delete 10, 100 and 150 from the tree; 10 and 150 might not exist in the tree, but 100 exists.
		tree.delete(10);
		tree.delete(100);
		tree.delete(150);
		...
		// Print the tree again.
		System.out.println();
		System.out.println("If you see the next output sorted, then your implementation of delete operation should be correct.");
		tree.inorderTreeTraversal();
	}
}
